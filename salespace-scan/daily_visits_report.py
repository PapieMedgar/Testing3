...
def generate_csv_bytes(start_date: Optional[date] = None, end_date: Optional[date] = None) -> bytes:
    """
    Generate the daily visits CSV as bytes, for API download (in-memory, no file I/O).
    """
